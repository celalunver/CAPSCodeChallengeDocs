...
- Decision 5 – After carefully examining the User Stories, the team is confident to implement the Code Challenge using Dynamics F&O infrastructure, except;
  * Issue 1 – The team is not sure whether the User will be redirected to Login page after logging out. This is Microsoft's default behavior and out of Etg's hands. This will be tested and will be discussed further in the upcoming meetings.
   * Issue 2 – Etg team thinks a “Planned” status should be added as the 4th label to project status labels (Created, Submitted, Approved) as it is a requirement set by User Story #6. 
...
### WORK TO BE DONE
- PBI's 5,6 and 7 will be implemented and unit tested today - Mesut, Enver
- The team decided to finish the implementation of Code Challenge today - Mesut, Enver 
- The whole User stories will be tested back to back today - Enver, Celal
- The team decided to put test cases (with screenshots) as well as a User manual to documentation - Celal

### DECISIONS
- The team decided to create a new Workspace under F&O for the Code Challenge project for a User friendly UI - Enver
- The team decided to put **Create Capital Project** and **5 year funding allocation** panels on the same page
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQxNDQ3MzY5LDQwOTM2MTUxNywxMzU3OD
YzMjY1LDMzNzMwMTgwOCwtNzQ5NDc2NDMxLC03MTY0Njk3ODMs
LTE4NDI1NDkzMiwxNDQ5MzY5NTkyLC05NDEzOTAyOTksNTMwMT
IxMTYsLTE1Njg4MzM0NTIsMTI4MDYzMzAwMiwxMDE2NzU0ODJd
fQ==
-->